...
NSString *const MJRefreshHeaderRefreshingText = @"正在刷新資料中...";

NSString *const MJRefreshAutoFooterIdleText = @"點擊或上拉加載更多";
NSString *const MJRefreshAutoFooterRefreshingText = @"正在加載更多的資料...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"已经全部加載完畢";

NSString *const MJRefreshBackFooterIdleText = @"上拉可以加載更多";
NSString *const MJRefreshBackFooterPullingText = @"鬆開立即加載更多";
NSString *const MJRefreshBackFooterRefreshingText = @"正在加載更多的資料...";
